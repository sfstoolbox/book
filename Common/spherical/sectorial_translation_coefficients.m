...
% m = M and n' = N_prime - 1
% structure of coefficients: 1st dimension:  n'
%                            2nd dimension:  m'
%                            3rd dimension:  m
%
...
% Eq. (3.55)
coefficients_3_55 = sectorial_translation_coefficients_2( M, N_prime, kr, d_alpha, d_beta, type );

[ dummy, n_prime, m ] = meshgrid( -N_prime + 1 : N_prime - 1,  0 : N_prime - 1, -M : M  );
...
function [ coefficients ] = sectorial_translation_coefficients_2( M, N_prime, kr, d_alpha, d_beta, type )
...
% 2nd dimension:  m'
% 3rd dimension:  m
coefficients = zeros( 2*N_prime, 4*N_prime - 1, 4*M + 1 );
